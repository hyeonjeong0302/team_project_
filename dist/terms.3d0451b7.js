...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/terms.js":[function(require,module,exports) {
document.addEventListener("DOMContentLoaded", function () {
  var totalTerms = document.getElementById("total_terms");
  var termsEls = document.querySelectorAll(".terms_el");
  var terms01 = document.getElementById("terms_01");
  var terms02 = document.getElementById("terms_02");
  ...
  function fregister_submit(f) {
    if (terms_01.checked === false) {
      alert("일광전구 이용약관에 동의해야 회원가입 하실 수 있습니다.");
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/terms.js"], null)
//# sourceMappingURL=/terms.3d0451b7.js.map
...
var loginId = document.getElementById("login_email");
...
function validationChk() {
  var id = document.getElementById("login_email");
  var pw = document.getElementById("login_pw");

  // 이메일 유효성 검사
  var idChk = /^[A-Za-z0-9_\.\-]+@[A-Za-z0-9\-]+\.[A-Za-z0-9\-]+/;
  if (id.value == "") {
    alert("아이디를 입력하세요.");
    id.focus();
    return false;
  ...
  if (idChk.test(id.value) == false) {
    ...
    // idChk.test(id.value) == true
    var setId = ["green@gmail.com", "green@naver.com", "green@hanmail.net"];
